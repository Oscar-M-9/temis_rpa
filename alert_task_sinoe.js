...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.File({
            // filename: 'logs/alert_task_sinoe.log',
            filename: '/home/temisperu/public_html/rpa.temisperu.com/RPA/logs/alert_task_sinoe.log',
            level: 'error',
        }),
...
async function obtenerRegistrosTask(conexion) {
    ...
    return new Promise((resolve, reject) => {
        conexion.query('SELECT * FROM task_expediente_sinoes WHERE estado = ? AND fecha_alerta  = ? ', ['En progreso', currentDate], (error, results) => {
            if (error) {
                reject(error);
