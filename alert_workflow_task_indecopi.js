...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.File({
            // filename: 'logs/alert_workflow_task_indecopi.log',
            filename: '/home/temisperu/public_html/rpa.temisperu.com/RPA/logs/alert_workflow_task_indecopi.log',
            level: 'info',
        }),
...
async function obtenerRegistrosTask(conexion) {
    ...
    return new Promise((resolve, reject) => {
        conexion.query('SELECT * FROM work_flow_task_indecopis WHERE estado = ? AND fecha_alerta  = ? ', ['En progreso', currentDate], (error, results) => {
            if (error) {
                reject(error);
                ...
                var htmlBuildMail = `
                    ...
                    <tbody>
                        ...
                        <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                            ...
                            Tiene una alerta de tarea en el expediente ${firstExp.numero} ${
