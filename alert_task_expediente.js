...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.File({
            // filename: 'logs/alert_task_expedientes.log',
            filename: '/home/temisperu/public_html/rpa.temisperu.com/RPA/logs/alert_task_expedientes.log',
            level: 'info',
        }),
...
async function obtenerRegistrosTask(conexion) {
    ...
    return new Promise((resolve, reject) => {
        conexion.query('SELECT * FROM task_expedientes WHERE estado = ? AND fecha_alerta  = ? ', ['En progreso', currentDate], (error, results) => {
            if (error) {
                reject(error);
