...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.File({
            // filename: 'logs/alert_workflow_task_suprema.log',
            filename: '/home/temisperu/public_html/rpa.temisperu.com/RPA/logs/alert_workflow_task_suprema.log',
            level: 'info',
        }),
...
async function obtenerRegistrosTask(conexion) {
    ...
    return new Promise((resolve, reject) => {
        conexion.query('SELECT * FROM work_flow_task_supremas WHERE estado = ? AND fecha_alerta  = ? ', ['En progreso', currentDate], (error, results) => {
            if (error) {
                reject(error);
