...
const logger = winston.createLogger({
    ...
    //   new winston.transports.File({ filename: 'logs/alert_indecopi.log' }) // Registra en un archivo
      new winston.transports.File({ filename: '/home/temisperu/public_html/rpa.temisperu.com/RPA/logs/alert_indecopi.log' }) // Registra en un archivo
    ],
});
...
async function enviarDatosAlEndpointUpdateMail(data, urlPage) {
    const endpointURL = urlPage + '/api/update-movements-indecopi';
    const jsonData = JSON.stringify(data);
